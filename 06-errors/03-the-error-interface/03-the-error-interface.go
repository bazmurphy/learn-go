...
// Error method for divideError, which implicitly implements the error interface
// The result of this method will be used when the divideError struct is converted to an error type
